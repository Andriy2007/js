...
for (const items of simpsons) {
    let elementDiv = document.createElement('div');
    elementDiv.setAttribute('class', 'member')
    elementDiv.innerText = `${items.name} ${items.surname} ${items.age} ${items.info} ${items.photo}`;
...
for (const courses of coursesArray) {
    let coursesElement = document.createElement('course');
    let title = document.createElement('h1');
    title.innerText = courses.title;
    let monthDurationItem = document.createElement('div');
    monthDurationItem.innerText = courses.monthDuration;
    let hourDurationItem = document.createElement('div');
    hourDurationItem.innerText = courses.hourDuration;
    let modules = document.createElement('ul');
    for (const moduleItem of courses.modules) {
        let liElement = document.createElement('li');
        liElement.innerText = moduleItem;
        modules.appendChild(liElement);
    }
    coursesElement.appendChild(title);
    coursesElement.appendChild(monthDurationItem);
    coursesElement.appendChild(hourDurationItem);
    coursesElement.appendChild(modules);
